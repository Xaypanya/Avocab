      ...
      <div className="flex justify-between items-start">
        <div className="flex-grow">
          ...
          <div className="flex items-center space-x-2 mb-3">
            <img
              src={LAOS_FLAG}
              alt="UK Flag"
              className="w-6 h-6 bg-blue-500 rounded-full border border-black"
            />
            <p className="text-md">{word.lao}</p>
          </div>
          <p className="text-sm text-gray-600 mt-2 bg-gray-100 inline-block px-2 py-1 rounded-full border border-gray-300">
            {word.type}
          </p>
        </div>
        <div className="flex flex-col items-center justify-center space-y-4">
          <button
            variant="outline"
            size="icon"
            className="p-1 border-2 border-black rounded-lg bg-yellow-300 hover:bg-yellow-400 active:bg-yellow-500 transition-colors"
            onClick={playAudio}
          >
          ...
          <button
            ...
            variant="outline"
            className={`p-1 ${
              word.favorite ? "bg-red-500" : "bg-white"
            } border-2 border-black rounded-full w-10 h-10 flex items-center justify-center`}
          >
            <Heart
              className={`h-5 w-5 ${
                word.favorite
